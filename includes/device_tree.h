...
void dt_read_cell_props(const struct device_tree_node *node, uint32_t * addrcp,
			uint32_t * sizecp);
...
void dt_add_string_prop(struct device_tree_node *node, const char *name,
			const char *str);
void dt_add_uint32_t_prop(struct device_tree_node *node, const char *name,
			  uint32_t val);
void dt_add_uint64_t_prop(struct device_tree_node *node, const char *name,
			  uint64_t val);
void dt_add_reg_prop(struct device_tree_node *node, uint64_t * addrs,
